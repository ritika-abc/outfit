...
<body>
    <!-- <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-11 col-lg-9 bg-white py-4 rounded">
                <div class="row">
                    <div class="col-md-6 mt-4">
                        <img src="img/register.jpg" height="100%" width="100%" style="object-fit: cover;" alt="">
                    </div>
                    <div class="col-md-6 mt-4">
                        <h5>Sign Up</h5>
                        ...
                        <p><small>Already have an account? <a href="" class="text-danger"> Sign In</a></small></p>
                    </div>
                </div>
            </div>
        </div>
